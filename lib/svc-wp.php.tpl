...
class {{plugin_ns}}_wp
{
  public static $plugin_name = "{{plugin_name}}";
  public static $option_namespace = "{{plugin_ns}}";
  public static $option_group = "{{plugin_ns}}_grp";
  public static $plugin_slug = "{{plugin_ns}}";
